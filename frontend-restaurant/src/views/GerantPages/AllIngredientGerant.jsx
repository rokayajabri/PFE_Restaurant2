            ...
            <div className="col-md-6">
                <div className="mb-3">
                    <h5 className="card-title">
                        List of Ingredient <span className="text-muted fw-normal ms-2">({ingredients.length})</span>                            </h5>
                </div>
            </div>
            <div className="col-md-6">
                <div className="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                    <div>
                        <Link to="/addIngredient" data-bs-toggle="modal"
                                    ...
                                    <td>
                                        <ul className="list-inline mb-0">
                                            <li className="list-inline-item">
                                                <Link to={`/editIngredient/${ingredient.id}`} href="javascript:void(0);"
                                            ...
                                            <li className="list-inline-item">
                                                <button onClick={() => handleDeleteConfirmation(ingredient.id)} href="javascript:void(0);"
                                                    data-bs-toggle="tooltip"
                                                    data-bs-placement="top"
                                                    title="Delete"
...
export default AllIngredientGerant;
