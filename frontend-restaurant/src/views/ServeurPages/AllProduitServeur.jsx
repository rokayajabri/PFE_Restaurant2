...
const AllProduitServeur = () => {
    ...
    const deleteProduit = async (id) => {
        try {
            ...
            await axios.delete(`http://127.0.0.1:8001/api/delete_produits/${id}`, { headers });
    ...
    return (
        <div>
             <div className="button-container">
                <Link to="/addProduit" className="add-button">
                                    ...
                                    <div className="price-and-icons">
                                        ...
                                        <ul className="icon-list">
                                            <li className="list-inline-item">
                                                <Link to={`/editProduit/${produit.id}`}
...
export default AllProduitServeur;
